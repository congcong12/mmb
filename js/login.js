                ...
                if(check){
                    function imgVer(Config) {
                        ...
                        $(".slider-btn").on('touchstart',function (e) {
                            ...
                            ontouchstart = e.touches[0].pageX;
                        });
                        $(".slider-btn").on('touchmove' , function (e) {
                            ...
                            console.log(moveX)
                            var d = moveX - ontouchstart;
                            console.log(d)
                            console.log(ontouchstart)
                            if (ontouchstart == '') {} else {
                        ...
                        $(".slider-btn").on('touchend' , function (e) {
                            e = e || window.event;
                            console.log(e.changedTouches[0].pageX)
                            var ontouchend = e.changedTouches[0].pageX - ontouchstart;
                            var ver_Num = X - 10;
                            var deviation = 4;
                            var Min_left = ver_Num - deviation;
                            var Max_left = ver_Num + deviation;
                            if (ontouchstart == '') {} else {
                                if (Max_left > ontouchend && ontouchend > Min_left) {
                                    $(".ver-tips").html('<i style="background-position:-4px -1207px;"></i><span style="color:#42ca6b;">恭喜!成功</span><span></span>');
                    ...
                    $(".submit").on('click', function () {
                        if ($(".username").val() == '') {
                            ...
                            $(".tips").html('老兄！！你用户名呢！？？？');
                            $("#logo").attr("src", 'images/10.gif')
                        } else if ($(".password").val() == '') {
                            // $(".err-password").html('畜生！！你密码呢！？？？');
                            $(".tips").html('老兄！！你密码呢！？？？');
                            $("#logo").attr("src", 'images/9.gif')
                        } else {
                            $(".login").css({
                                "left": "-404px",
                                "opacity": "0"
